<?php
/**
 * Class Ig_PaymentFee_Helper_Data
 */
class Ig_PaymentFee_Helper_Data extends Mage_Core_Helper_Abstract {
    /**
     ...
     * @return string
     */
    public function getFeeOperator() {
        return $this->getConfig('fee_operator');
    }
