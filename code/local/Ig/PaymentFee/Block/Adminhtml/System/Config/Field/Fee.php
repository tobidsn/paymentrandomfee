...
* 
*/
class Ig_PaymentFee_Block_Adminhtml_System_Config_Field_Fee extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract {
    ...
    protected function _prepareToRender() {
        ...
        $this->addColumn('fee', array('label' => Mage::helper('payment_fee')->__('From Fee')));
        $this->addColumn('tofee', array('label' => Mage::helper('payment_fee')->__('To Fee')));
